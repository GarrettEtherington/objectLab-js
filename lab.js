...
let favoriteThings = {
  band: `TWRP`,
  food: `Mexican`,
  person: `My evil sister`,
  book: `There's An Enemy Sub In Potter's Pond`,
  movie: `Spirited Away`,
  holiday: `Christmas`
}
...
favoriteThings.show = `Jojo's Bizzare Adventure`
...
console.log(carModel, carMake, carYear)
...
let Meow = new Cat(`Destructor`, `1.5`, `Orang`)
...
let wizeMan = new Wizard(`Mandalf the Sleepless`, `40,000`, `Placidusax' Ruin`)
wizeMan.castSpell()
...
//Code Here
let phone1 = new Phone(`At&t`, `JS 1000`, 4, `white`, 75)
let phone2 = new Phone(`Sony`, `A10E`, 10, `black`, 60)
let phone3 = new Phone(`OnePLus`, `12`, 15, `teal`, 80)
/* 
...
//Code Here
const myFirstVehicle = new Vehicle(4, `silver`, 35000)
